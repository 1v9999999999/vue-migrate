            ...
            <div class="userinfo-right rflex">
                ...
                <div class="userinfo">
                    <el-menu 
                       ...
                       mode="horizontal" 
                       >
                        <el-sub-menu index="1" popper-class="langItem">
                            <template #title>
                                <template>
                        ...
                        <el-sub-menu index="2"  popper-class="infoItem">
                            <template #title>
                                <template>
                                    <div class='welcome'>
...
export default {
   ...
   * @returns {{logo: unknown, langLogo: any, chinaImg: unknown, americaImg: unknown, wechat: { wechatImg: unknown; isWechat: boolean }, qq: { qqImg: unknown; isQq: boolean }, github: unknown, menu: { userBgcolor: string }}}
   */
  data() {
    return {
      logo: logoImg,
  ...
  methods: {
    ...
    */
     ...
     * vue3-types TODO:
     * 
     *   - $router ×2: this.$router → useRouter()  (vue-router@4)
     */
