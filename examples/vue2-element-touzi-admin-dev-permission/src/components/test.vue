...
<script>export default {
   ...
   * @returns {{formData: { mobile: string; field101: undefined; field102: undefined; field103: undefined; field105: null; field106: number; field104: any[]; field108: undefined }, rules: { mobile: { required: boolean; message: string; trigger: string } | { pattern: RegExp; message: string; trigger: string }[]; field101: { required: boolean; message: string; trigger: string }[]; field102: { required: boolean; message: string; trigger: string }[]; field103: { required: boolean; message: string; trigger: string }[]; field105: { required: boolean; message: string; trigger: string }[]; field106: { required: boolean; message: string; trigger: string }[]; field104: { required: boolean; type: string; message: string; trigger: string }[]; field108: { required: boolean; message: string; trigger: string }[] }, field103Options: { label: string; value: number }[], field104Options: { label: string; value: number }[], field108Options: { label: string; value: number }[]}}
   */
  data() {
    return {
      formData: {
