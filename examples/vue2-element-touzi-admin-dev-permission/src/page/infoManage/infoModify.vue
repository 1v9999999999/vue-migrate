...
<script>import * as mutils from '@/utils/mUtils';
import { ElMessage } from "element-plus";
export default {
  /*
   * vue3-types inferred data() return type:
   * @returns {{infoForm: { username: string; nickname: string; touziyear: string; email: string; telphone: string }, pwdForm: { password: string; newpassword: string; surepassword: string }, phoneForm: { phone: string; baseType: any[]; changeType: any[] }, infoRules: { nickname: { required: boolean; message: string; trigger: string } | { min: number; max: number; message: string; trigger: string }[]; touziyear: { required: boolean; message: string; trigger: string }[]; email: { required: boolean; validator: unknown; trigger: string }[]; telphone: { required: boolean; validator: unknown; trigger: string }[] }, pwdRules: { password: { required: boolean; message: string; trigger: string }[]; newpassword: { required: boolean; validator: unknown; trigger: string }[]; surepassword: { required: boolean; validator: unknown; trigger: string }[] }, phoneRules: { phone: { required: boolean; validator: unknown; trigger: string }[]; baseType: { type: string; required: boolean; message: string; trigger: string }[]; changeType: { type: string; required: boolean; message: string; trigger: string }[] }}}
   */
  data() {
